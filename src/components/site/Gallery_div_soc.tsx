...
import socialScience1 from "@/assets/images/divisions/Social Science/Social Science 2.jpg";
import socialScience2 from "@/assets/images/divisions/Social Science/Social Science.jpg";
import socialScience3 from "@/assets/images/divisions/Social Science/Social Science3.jpg";



const items = [
  { src: socialScience1, cat: "Social Science", h: "" },
  { src: socialScience2, cat: "Social Science", h: "" },
  { src: socialScience3, cat: "Social Science", h: "" },
];

const cats = ["Social Science"];

export function Gallery() {
  const [filter, setFilter] = useState("Social Science");
    ...
    <section id="gallery" className="py-24 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        <h2 className="mt-3 font-display text-4xl lg:text-5xl font-bold">
          Social Science <span className="text-gradient">Gallery.</span>
        </h2>
