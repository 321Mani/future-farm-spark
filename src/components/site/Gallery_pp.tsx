...
import g1 from "@/assets/images/Plant_Protection2.webp";
import g2 from "@/assets/images/Plant_Protection3.webp";
import g3 from "@/assets/images/Plant_Protection4.webp";
import g4 from "@/assets/images/Plant_Protection.webp";

const items = [
  { src: g1, cat: "Plant Protection", h: "" },
  { src: g2, cat: "Plant Protection", h: "" },
  { src: g3, cat: "Plant Protection", h: "" },
  { src: g4, cat: "Plant Protection", h: "" },
];
    ...
    <section id="gallery" className="py-24 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        <h2 className="mt-3 font-display text-4xl lg:text-5xl font-bold">
          Plant Protection <span className="text-gradient">Gallery.</span>
        </h2>
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 auto-rows-[250px] gap-4">
          {filtered.map((img, i) => (
            <motion.button
              key={img.src}
              layout
