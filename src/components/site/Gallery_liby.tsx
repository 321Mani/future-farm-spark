...
import g1 from "@/assets/images/lib (1).jpg";
import g2 from "@/assets/images/lib (2).jpg";
import g3 from "@/assets/images/lib (3).jpg";
import g4 from "@/assets/images/lib (4).jpg";
import g5 from "@/assets/images/lib (5).jpg";
    ...
    <section id="gallery" className="py-24 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        <h2 className="mt-3 font-display text-4xl lg:text-5xl font-bold">
          Library <span className="text-gradient">Gallery.</span>
        </h2>
