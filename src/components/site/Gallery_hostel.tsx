...
import g1 from "@/assets/images/Hostel/1.jpg";
import g2 from "@/assets/images/Hostel/1313.jpg";
import g3 from "@/assets/images/Hostel/2.jpg";
import g4 from "@/assets/images/Hostel/3.jpg";
import g5 from "@/assets/images/Hostel/45.jpg";
import g6 from "@/assets/images/Hostel/ASDD.jpg";
import g7 from "@/assets/images/Hostel/ERDF.jpg";
    ...
    <section id="gallery" className="py-24 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        <h2 className="mt-3 font-display text-4xl lg:text-5xl font-bold">
          Hostel <span className="text-gradient">Gallery.</span>
        </h2>
