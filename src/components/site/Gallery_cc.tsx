...
import g2 from "@/assets/images/cc 2.webp";
import g3 from "@/assets/images/cc 3.webp";

const items = [
  { src: g1, cat: "Computer Center", h: "" },
  { src: g2, cat: "Computer Center", h: "" },
  { src: g3, cat: "Computer Center", h: "" },
];
    ...
    <section id="gallery" className="py-24 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        <h2 className="mt-3 font-display text-4xl lg:text-5xl font-bold">
          Computer Center <span className="text-gradient">Gallery.</span>
        </h2>
